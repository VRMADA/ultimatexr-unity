    ...
    public partial class UxrGrabManager : UxrSingleton<UxrGrabManager>, IUxrStateSync
    {
        ...
        private void UpdateSmoothHandTransitions(float deltaTime)
        {
            ...
            foreach (KeyValuePair<UxrGrabber, HandTransitionInfo> handTransitionPair in _handTransitions)
            {
                ...
                handTransitionPair.Key.HandBone.SetPositionAndRotation(Vector3.Lerp(handTransitionPair.Value.StartPosition, handTransitionPair.Key.transform.TransformPoint(handTransitionPair.Key.HandBoneRelativePos), t), Quaternion.Slerp(handTransitionPair.Value.StartRotation, handTransitionPair.Key.transform.rotation * handTransitionPair.Key.HandBoneRelativeRot, t));
